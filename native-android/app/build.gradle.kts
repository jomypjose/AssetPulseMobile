...
android {
    namespace = "com.assetpulse.monitor"
    compileSdk = 36

    defaultConfig {
        // Reused from the Expo app's app.config.js so the native client keeps
        // the same identity on Play / on-device.
        applicationId = "com.assetpulse.monitor"
        minSdk = 26
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
